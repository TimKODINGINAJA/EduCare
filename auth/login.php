...
<head>
  ...
  <title data-i18n="page.login">Masuk Akun — EduCare</title>
  ...
  <style>
    ...
    /* ======================================================================
       ...
       Layer 2: glow warna brand (indigo/violet/biru) yang mengambang perlahan
    ...
    /* Kartu login: border glow tipis yang "bernapas" perlahan mengikuti warna aurora */
    .login-card {
      position: relative;
    }
...
<body class="font-sans text-gray-900 antialiased bg-gray-100 dark:bg-[#0b1120] transition-colors duration-300">
  ...
  <div class="min-h-screen flex flex-col items-center justify-center px-4 py-8">
    ...
    <!-- Login Card -->
    <div
      class="login-card w-full sm:max-w-lg px-5 sm:px-10 py-8 sm:py-9 bg-white dark:bg-slate-900 shadow-md dark:shadow-none dark:border dark:border-slate-800 rounded-xl transition-colors duration-300">

      <!-- Heading -->
      <div class="mb-7">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-1" data-i18n="auth.login.title">
          Masuk ke Akun Anda
        </h2>

        <p class="text-sm text-gray-500 dark:text-slate-400" data-i18n="auth.login.subtitle">
          Masuk untuk melanjutkan belajar dari nol.
        </p>
      </div>
      ...
      <?php if (isset($_SESSION['error'])) : ?>
        ...
        <div
          class="mb-5 px-4 py-3 rounded-md text-sm bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 font-medium border border-red-100 dark:border-red-500/30">
      ...
      <?php if (isset($_SESSION['success'])) : ?>
        ...
        <div
          class="mb-5 px-4 py-3 rounded-md text-sm bg-green-50 dark:bg-emerald-500/10 text-green-600 dark:text-emerald-400 font-medium border border-green-100 dark:border-emerald-500/30">
      ...
      <form action="login_process.php" method="POST">
        ...
        <div>
          ...
          <label
            ...
            data-i18n="auth.login.email_label">
          ...
          <input
            ...
            data-i18n-placeholder="auth.login.email_placeholder"
        ...
        <div class="mt-5">
          ...
          <label
            for="password"
            class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5"
            data-i18n="auth.login.password_label">
          ...
          <div class="relative">
            ...
            <input
              ...
              data-i18n-placeholder="auth.login.password_placeholder"

              class="block w-full h-12 px-4 pr-12
                     rounded-md
                     border border-gray-300 dark:border-slate-700
                     bg-white dark:bg-slate-800
                     shadow-sm
        ...
        <div class="flex items-center justify-between mt-5">
          ...
          <label class="flex items-center cursor-pointer">
            ...
            <span class="ml-2 text-sm text-gray-600 dark:text-slate-400" data-i18n="auth.login.remember">
              Ingat saya
            </span>
          ...
          <a
            ...
            class="text-sm text-gray-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition"
            data-i18n="auth.login.forgot">
      ...
      <div
        ...
        <span class="text-gray-500 dark:text-slate-400" data-i18n="auth.login.no_account">
          Belum memiliki akun?
        </span>
        ...
        <a
          ...
          class="font-semibold
                 ...
                 ml-1
                 transition"
          data-i18n="auth.login.signup_link">
    ...
    <p class="mt-6 text-center text-xs text-gray-400 dark:text-slate-600">
      ...
      &copy; <?= date('Y') ?> EduCare.
      <span data-i18n="auth.login.copyright">Hak cipta dilindungi undang-undang.</span>
